...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/nmiabdfhmy/Zelda-File-Single)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/nmiabdfhmy/Zelda-File-Single
cd Zelda-File-Single
...
[ZELDA FILE](https://github.com/nmiabdfhmy/Zelda-File-Single/) is Free Software: You can use, study share and improve it at your
